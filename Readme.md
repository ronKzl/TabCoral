...
- [/] User is able to choose to save all/none of their current groups <--- WIP (saving process under a rework)
...
- [ ] User is able to create working profiles, each with certain tabs open (Work, Game, Research etc.) <--- WIP
